...
class StoryList {
  ...
  async addStory(user, {title, author, url}) {
    ...
    // POST Request to API w/ "stories" endpoint. Pass in object containing the token and story data
    const response = await axios.post(`${BASE_URL}/stories`, 
    {token,
     story: {title, author, url}
    });
    
    const story = new Story(response.data.story);  // pass in new story data into new Story instance 
    this.stories.unshift(story); // unshift() used to add one or more elements to beginning of an array. 
    user.ownStories.unshift(story); // adds to array for user's posts list. Refer to User class. 
